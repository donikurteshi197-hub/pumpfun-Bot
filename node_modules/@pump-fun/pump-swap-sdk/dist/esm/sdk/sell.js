...
function sellBaseInput({
  ...
  const coinCreatorFee = PublicKey3.default.equals(coinCreator) ? new BN3(0) : fee(quoteAmountOut, coinCreatorFeeBps);
...
function sellQuoteInput({
  ...
  const rawQuote = calculateQuoteAmountOut(
    ...
    lpFeeBps,
    protocolFeeBps,
    PublicKey3.default.equals(coinCreator) ? new BN3(0) : coinCreatorFeeBps
  );
