...
import { G as GlobalConfig, F as FeeConfig, P as Pool, k as GlobalVolumeAccumulator, U as UserVolumeAccumulator, c as CreatePoolSolanaState, o as SwapSolanaState, l as LiquiditySolanaState, C as CollectCoinCreatorFeeSolanaState } from '../sdk-CJd3XgI3.mjs';
...
declare class OnlinePumpAmmSdk {
     ...
     */
    setCoinCreatorFeeBpsInstructions(coinCreator: PublicKey, poolKey: PublicKey, creatorFeeBps: BN): Promise<TransactionInstruction[]>;
    /**
     ...
     */
    adminSetCoinCreatorFeeEditableInstructions(poolKey: PublicKey): Promise<TransactionInstruction[]>;
