...
import { G as GlobalConfig, F as FeeConfig, S as SellBaseInputResult, m as SellQuoteInputResult } from '../sdk-CJd3XgI3.mjs';

declare function sellBaseInput({ base, slippage, baseReserve, quoteReserve, virtualQuoteReserves, globalConfig, baseMintAccount, baseMint, coinCreator, creator, feeConfig, quoteMint, isMayhemMode, creatorFeeBps, }: {
    base: BN;
    slippage: number;
    baseReserve: BN;
    quoteReserve: BN;
...
declare function sellQuoteInput({ quote, slippage, baseReserve, quoteReserve, virtualQuoteReserves, globalConfig, baseMintAccount, baseMint, coinCreator, creator, feeConfig, quoteMint, isMayhemMode, creatorFeeBps, }: {
    quote: BN;
    slippage: number;
    baseReserve: BN;
    quoteReserve: BN;
